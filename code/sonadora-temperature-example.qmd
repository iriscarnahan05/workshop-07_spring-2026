...
Question: Does elevation (in meters) predict air temperature (in °C)?

H~0~: The elevation (m) does not predict air temperature (°C).

H~A~: The elevation (m) predicts temperature (°C).
